...
public class SampleService {
    ...
    public void doSomething(int id, String something) {
        ...
        OutboxRecord rec = outboxService.saveForPublishing(topic1, String.valueOf(id), something.getBytes());
        logger.info("Stored event [{}] in outbox with id {} and key {}", something, rec.getId(), rec.getKey());
    }
    ...
    public void doSomethingWithAdditionalHeaders(int id, String something, Header...headers) {
        ...
        OutboxRecord rec = outboxService.saveForPublishing(topic1, String.valueOf(id), something.getBytes(), headerMap);
        logger.info("Stored event [{}] in outbox with id {}, key {} and headers {}", something, rec.getId(), rec.getKey(), rec.getHeaders());
    }
