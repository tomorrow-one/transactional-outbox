...
dependencies {
    ...
    implementation("org.springframework.data:spring-data-r2dbc:3.1.3")
    ...
    // testing
    testImplementation("org.springframework.boot:spring-boot-autoconfigure:3.1.4")
